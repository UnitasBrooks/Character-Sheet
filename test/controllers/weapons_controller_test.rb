...
class WeaponsControllerTest < ActionController::TestCase
  ...
  test "should create weapon" do
    assert_difference('Weapon.count') do
      post :create, weapon: { dice_num: @weapon.dice_num, dice_sides: @weapon.dice_sides, name: @weapon.name }
    end
  ...
  test "should update weapon" do
    patch :update, id: @weapon, weapon: { dice_num: @weapon.dice_num, dice_sides: @weapon.dice_sides, name: @weapon.name }
    assert_redirected_to weapon_path(assigns(:weapon))
  end
